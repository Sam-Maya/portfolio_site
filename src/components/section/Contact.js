                ...
                <div className="container">
                    <div className="git-cont row">
                        ...
                        <div className="col-12 col-sm-6 half">
                            ...
                            <p>
                                Checkout my socials and download my resume below.
                            </p>
                            <div className="d-flex justify-content-center align-items-center flex-column">
                                ...
                                {social.resume && <a to="../../../public/SamuelMayaResume2022" title="Download Resume" href={social.resume} download><i className="fas fa-download"></i></a>}
                            </div>
                        </div>
                    </div>
                </div>
